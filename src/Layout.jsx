...
export default function Layout({ children, currentPageName }) {
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      {/* Mobile top bar */}
      <div className={`md:hidden fixed left-0 right-0 z-50 bg-[#d6cbc1] border-b border-pink-300 px-4 h-14 flex items-center justify-between shadow-sm ${showPWA ? "top-10" : "top-0"}`}>
      ...
      {/* Main content */}
      <main className={`md:ml-64 min-h-screen bg-[#d6cbc1] ${showPWA ? "pt-24 md:pt-10" : "pt-14 md:pt-0"}`}>
        ...
        <div className="hidden md:block fixed top-6 right-6 z-40">
          <Link to={createPageUrl("Notifications")} className="relative inline-block">
            <div className="p-2 rounded-lg bg-[#d6cbc1] border border-pink-300 hover:bg-pink-300 transition-colors">
